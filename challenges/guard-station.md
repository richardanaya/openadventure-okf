...
type: "Challenge"
title: "Guard Station"
description: "A pair of guards prevent the characters from gaining entrance to the castle."
...
source_start_line: 8043
source_end_line: 8074
...
| Protection: | — |
| Traits: | — |
| **Actions**: | **Bribe** (DS 4), **[Deceive](/actions/deceive.md)** (DS 6), **[Sneak](/actions/sneak.md)** (DS 9) |
...
* **[Deceive](/actions/deceive.md)** (DS 6): The guards are used to people trying to talk their way into the castle, but they aren’t experts when it comes to detecting deception.
* **[Sneak](/actions/sneak.md)** (DS 9): The guards have sharp eyes and after a reprimand for failing to spot a visitor’s dagger, they are more on alert than usual.
