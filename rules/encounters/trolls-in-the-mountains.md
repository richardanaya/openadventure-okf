---
type: "Example"
title: "Encounter: Trolls in the Mountains"
description: "A mountain encounter featuring trolls guarding a narrow trail."
...
source_start_line: 4128
source_end_line: 4163
...
* **3 Trolls** (Adversaries): See [NPCs and Adversaries](/npcs/) for [the troll statblock](/npcs/troll.md). The trolls want to eat the characters, so they won’t try to push any of the characters down into the crevasse. In fact, if a character falls, a troll might catch the character and toss them back onto the bridge. They don’t want to lose their dinner!
...
* **If the characters reach the troll treasure** they are awarded:
  ...
  + 125 SP
  + 240 CP
  + A masterfully crafted elven longsword engraved with ancient runes. It is not magical, but it is worth five times as much as a normal longsword. It also never loses its edge.
  + A large gold goblet of dwarven make worth 575 SP.
