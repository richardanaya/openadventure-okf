...
Here is easiest way to set a Difficulty Score.

1. **Listen** to the player describe their Action.
2. **Ensure** the player tells you the **What, How, and Why** of the Action.
3. **Decide** what level of skill is required to succeed at the base task under normal circumstances.
4. **Select** the appropriate Difficulty Score from the table.
