...
A character’s **Modus Operandi (MO)** represents the package of skills, talents, and tricks they use when adventuring. It also helps define their place in society, the types of occupations they are suited for, and how are perceived by others.
...
The character’s **exceptional abilities** are traits that set them apart from the other people in the world and qualities that make them uniquely suited for life as an adventurer. The [Exceptional Abilities](/rules/character-creation/exceptional-abilities/) catalog lists the abilities available in the Core Rules and the benefits each ability provides.
...
The character backstory section on the back of the character sheet helps describe your character’s personality, their history, and their motivations. You may fill these in with whatever you like, fill them in as you learn more about your character while playing, or you can roll on the [Backstory Tables](/backstory/).
