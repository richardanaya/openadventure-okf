---
type: "Rule"
title: "Welcome to Open Adventure: Fantasy"
description: "Introduces Open Adventure: Fantasy, roleplaying games, the core rules, and the materials needed to play."
...
source_start_line: 953
source_end_line: 1010
derivation: "transformed-extract"
---
# Welcome to Open Adventure: Fantasy

So, you're looking for an adventure! Well, you've come to the right place. Everything you and your friends need to travel to distant lands filled with magic, dragons, and wonder is here in this rules bundle. You'll traverse dangerous dungeons, climb wizards’ towers, explore the ruins of long forgotten temples, and stalk the streets of ancient cities crawling with pirates and thieves. As you overcome the challenges placed before you, you will be rewarded with magically enchanted artifacts, powerful allies, invaluable experience, and more than a little bit of gold!

## About These Rules

The *Open Adventure: Fantasy* Core Rules set you up to play roleplaying games in fantasy worlds like those described in J.R.R. Tolkien’s *The Lord of the Rings*, Mercedes Lackey’s *Valdemar* books, Robert E. Howard’s *Conan* stories, or N.K. Jemisin’s *Broken Earth* trilogy. Everything you need, aside from some dice, pencils and paper, and a friend or two to play with, is included in this rules bundle.
...
The Adventure Guide needs a copy of these rules, although it is helpful if everyone at the table has a copy. The digital version of *Open Adventure: Fantasy* is available free wherever you get your digital books, or you can download a copy from [openadventurerpg.com](https://www.openadventurerpg.com).
...
This rules bundle does not include a campaign setting, but for the purposes of teaching the game, it includes rules for the common elements of classic fantasy worlds. From dwarves to dragons, it has everything you need to go on adventures in your favorite fantasy world.

## The History of Open Adventure

*Open Adventure* is the result of a successful crowdfunding campaign completed in 2023. The goal of the campaign was to create a new roleplaying game system and then give it to the world. This release is the product of that effort. *Open Adventure* belongs to the roleplaying community. Anyone can play, copy, publish, or leverage this system for anything they wish (commercial or personal) without getting special permission, paying a licensing fee, facing the interference of a self-interested third party, or even providing attribution. For complete details about *Open Adventure’s* open content, visit [openadventurerpg.com](https://www.openadventurerpg.com).
