...
description: "Catalogs 51 example Actions and explains how to adapt their rules to the circumstances and fiction of play."
tags: ["open-adventure", "fantasy", "core-rules", "reference", "actions", "overview"]
license: "CC0-1.0"
source_uri: "https://www.openadventurerpg.com/coc"
source_artifact: "Open-Adventure-Fantasy-Core-Rules-Text-v1.0.md"
source_revision: "v1.0"
source_sha256: "7f48d6312e365ffbf25abc1597e076e1dd5d5d3ec61c91e440147490b146993f"
source_start_line: 6423
source_end_line: 6481
...
PLAYER 5 wants to sneak up and knock out the guard with a club. On the surface, this is a simple Strength-based **[Attack: Melee or Ranged](/actions/attack-melee-or-ranged.md)** Action. The player, however, wants their character to use stealth and cunning to pull this off rather than pure muscle. The Adventure Guide rules the character may perform a **[Sneak Check](/actions/sneak.md)** instead, using the target’s Reaction as the Difficulty Score instead of Body Defense. Just like an Attack Action, a success will reduce the target’s Challenge Points by the Effect.
...
PLAYER 6 wants to play a serpentfolk character with the ability to paralyze enemies using hypnosis. PLAYER 6 made this lineage up, and the Core Rules don’t have any rules for hypnosis. The Adventure Guide looks at the Action Library and decides that hypnotizing someone is really just a Grab using the Mind. They rule PLAYER 6 can use the **[Grab](/actions/grab.md)** and **[Restrain](/actions/restrain.md)** Actions but with Presence for the Primary Attribute and Mind Defense as the target’s Defense. To break free of the hypnosis, an enemy may use the **[Escape Action](/actions/escape.md)** using their Presence instead of Strength or Coordination.
...
**3. [Attribute](/rules/attributes/)**: Suggested Primary Attribute to use when calculating the Action Score. The Adventure Guide may allow the use of a different Attribute if appropriate.
...
**4. [Difficulty](/rules/actions.md#step-2-set-the-difficulty-score-ds)**: Suggested base Difficulty Score for the Action Check or factors the Adventure Guide should consider when setting the Difficulty Score.
...
**7. [Base Time](/rules/encounters/core-rules.md#round-length)**: The amount of time typically required to perform the Action. Actions requiring One Round take as long to perform as the current Round length.

**8. [Outcome](/rules/actions.md#step-5-describe-the-results)**: The outcome if the Action Check is successful.
...
For more information about NPCs and Actions, see [Actions](/rules/actions.md).
