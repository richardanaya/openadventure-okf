...
type: "Action"
title: "Track"
description: "Follow a set of tracks."
...
source_start_line: 7715
source_end_line: 7737
...
On a successful **Track** Check, the character can follow a set of tracks. Before a character starts Tracking, they must find the tracks. Obvious tracks are easy to spot and do not require an Action Check to find. Tracks on hard surfaces, old tracks, or tracks that are otherwise concealed or obscured may require a successful **[Search](/actions/search.md)** Check to locate. Only after the tracks are found may the character begin Tracking.
